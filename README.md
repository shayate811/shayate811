<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=200&color=gradient&text=Hi%20👋,%20I'm%20shayate811&fontSize=50&fontColor=E0CCFF&animation=fadeIn" alt="header" />
</div>

<div align="center">
  <h3>"Elegant Architecture, Pragmatic Execution" (Starting 2026 August) </h3>
...
| **Backend** | ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white) ![Node.js](https://img.shields.io/badge/-Node.js-339933?style=flat&logo=node.js&logoColor=white) ![Express](https://img.shields.io/badge/-Express-000000?style=flat&logo=express&logoColor=white) |
...
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=shayate811&layout=compact&theme=dark&exclude_repo=atCoder&hide=html,css,TeX,Jupyter%20Notebook&langs_count=6)](https://github.com/anuraghazra/github-readme-stats)
...
<!-- BLOG-POST-LIST:START -->
 - 2026/01/25 📘 [k8s Serviceの負荷分散は本当にランダムなのか？iptablesのOSSコードから裏取りしてみた](https://zenn.dev/shayate811/articles/k8s-proxy-service)
 - 2025/12/20 📘 [脳科学&lpar;fMRI&rpar;のレガシー資産「SPM12」をDockerに閉じ込めてMチップ Macで強制起動する](https://zenn.dev/shayate811/articles/spm12-for-mac)
 ...
 - 2025/12/04 📘 [Dev Containersで「本番同等の通信経路」を再現すべき技術的理由 マイクロサービス開発の落とし穴と解決策](https://zenn.dev/shayate811/articles/dev-container)<!-- BLOG-POST-LIST:END -->
<br/>
